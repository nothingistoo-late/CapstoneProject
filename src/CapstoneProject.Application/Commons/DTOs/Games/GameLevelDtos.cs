...
/// <summary>Input một level khi tạo/sửa game (API JSON body).</summary>
public class MapLevelInputDto
{
    public int LevelOrder { get; set; }
    public string? Title { get; set; }
    public JsonElement JsonContent { get; set; }
    /// <summary>Gợi ý theo level (hoặc lấy từ JSON field <c>hints</c> trong game detail).</summary>
...
/// <summary>Level trong response GET game detail.</summary>
