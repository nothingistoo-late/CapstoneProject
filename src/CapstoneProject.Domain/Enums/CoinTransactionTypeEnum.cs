...
/// Coin is only added when: (1) user deposits real money (EarnDeposit), (2) user's game is purchased by another (EarnMapSold).
/// </summary>
public enum CoinTransactionTypeEnum
{
    ...
    /// <summary>Credited when another user purchases the creator's game (with optional platform fee).</summary>
    EarnMapSold = 1,

    /// <summary>Debited when user purchases a game from another user.</summary>
    SpendMapPurchase = 2,
