...
/// <summary>
/// Lịch sử chơi game của user (mỗi lần validate/submit có thể tạo 1 record).
/// Mục tiêu: FE/BE có thể phân tích hành vi chơi, tiến độ theo phiên chơi.
/// </summary>
public class UserGamePlayHistory : BaseEntity
{
    public Guid UserId { get; set; }
    public Guid GameId { get; set; }
    /// <summary>Level đang chơi (GameDetails.Id), optional.</summary>
    ...
    /// <summary>
    /// true: user nộp accepted (có kết quả win) và game được coi là "hoàn thành" theo logic hiện tại.
    /// </summary>
